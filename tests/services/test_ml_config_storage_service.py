...
@pytest.fixture
def prophet_test_config() -> ProphetMLConfig:
...
def test_save_config(ml_config_storage_service: MLConfigStorageService, prophet_test_config: ProphetMLConfig) -> None:
...
def test_update_config(ml_config_storage_service: MLConfigStorageService, prophet_test_config: ProphetMLConfig) -> None:
...
def test_delete_config(ml_config_storage_service: MLConfigStorageService, prophet_test_config: ProphetMLConfig) -> None:
