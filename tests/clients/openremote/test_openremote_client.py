...
def test_retrieve_assets_with_historical_datapoints(openremote_client: OpenRemoteClient) -> None:
    ...
    """
    assets: list[Asset] | None = openremote_client.retrieve_assets_with_historical_datapoints("smartcity")
